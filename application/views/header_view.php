        ...
        <nav id="navigation-box" style="margin-left: 250px; float:left;width: 1050px;">
            ...
            <ul id="navigation">
                ...
                <li>
                    ...
                    <?php else: ?>
                        <a href="#" class="open-login-modal">Tài khoản</a>
                    <?php endif; ?>
                </li>

                <li>
                    <?php if ($is_logged_in): ?>
                        <a href="<?php echo base_url(); ?>index.php/showuser_controller/indexshowuser">
                ...
                <li>
                    ...
                    <?php else: ?>
                        <a href="#" class="open-register-modal">Đăng ký</a>
                    <?php endif; ?>
                </li>
            </ul>
